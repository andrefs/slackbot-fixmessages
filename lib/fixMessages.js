...
var _fixApostrophe = function(text){
    var res = text
        .replace(/a'(\W)/g,'á$1').replace(/a'$/g,'á')
        .replace(/e'(\W)/g,'é$1').replace(/e'$/g,'é')
        .replace(/i'(\W)/g,'í$1').replace(/i'$/g,'í')
        .replace(/o'(\W)/g,'ó$1').replace(/o'$/g,'ó')
        .replace(/u'(\W)/g,'ú$1').replace(/u'$/g,'ú')
    if(res !== text){
